...
public class TftCrawlerService {
    ...
    public TftCrawlerService(RiotLeagueClient leagueClient, CrawlerTaskRepository taskRepository, InMemoryMatchQueueService queueService) {
    ...
    public void processarTarefasPendentes() {
        ...
        System.out.println("[CRAWLER] Despachando " + tarefasPendentes.size() + " jogadores para a fila de processamento...");
